...
class HXCPP_CLASS_ATTRIBUTES  GfxBytes_obj : public ::format::gfx::Gfx_obj{
	public:
		...
		GfxBytes_obj();
		Void __construct(::openfl::_v2::utils::ByteArray inBuffer,hx::Null< int >  __o_inFlags);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< GfxBytes_obj > __new(::openfl::_v2::utils::ByteArray inBuffer,hx::Null< int >  __o_inFlags);
