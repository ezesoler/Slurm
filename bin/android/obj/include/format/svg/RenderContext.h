...
class HXCPP_CLASS_ATTRIBUTES  RenderContext_obj : public hx::Object{
	public:
		...
		RenderContext_obj();
		Void __construct(::openfl::_v2::geom::Matrix inMatrix,::openfl::_v2::geom::Rectangle inRect,Dynamic inW,Dynamic inH);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< RenderContext_obj > __new(::openfl::_v2::geom::Matrix inMatrix,::openfl::_v2::geom::Rectangle inRect,Dynamic inW,Dynamic inH);
