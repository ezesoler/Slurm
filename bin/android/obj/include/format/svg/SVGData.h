...
class HXCPP_CLASS_ATTRIBUTES  SVGData_obj : public ::format::svg::Group_obj{
	...
	public:
		...
		virtual Float applyTransform( ::openfl::_v2::geom::Matrix ioMatrix,::String inTrans);
		...
		virtual ::format::svg::Group loadGroup( ::format::svg::Group g,::Xml inG,::openfl::_v2::geom::Matrix matrix,::haxe::ds::StringMap inStyles);
		Dynamic loadGroup_dyn();

		virtual ::format::svg::Path loadPath( ::Xml inPath,::openfl::_v2::geom::Matrix matrix,::haxe::ds::StringMap inStyles,bool inIsRect,bool inIsEllipse,hx::Null< bool >  inIsCircle);
		Dynamic loadPath_dyn();

		virtual ::format::svg::Text loadText( ::Xml inText,::openfl::_v2::geom::Matrix matrix,::haxe::ds::StringMap inStyles);
