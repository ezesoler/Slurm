...
class HXCPP_CLASS_ATTRIBUTES  TransformActuator_obj : public ::motion::actuators::SimpleActuator_obj{
	...
	public:
		...
		virtual Void setField_openfl__v2_geom_Transform( ::openfl::_v2::geom::Transform target,::String propertyName,Dynamic value);
		Dynamic setField_openfl__v2_geom_Transform_dyn();
