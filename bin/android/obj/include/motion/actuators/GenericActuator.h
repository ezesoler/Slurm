...
class HXCPP_CLASS_ATTRIBUTES  GenericActuator_obj : public hx::Object{
	...
	public:
		...
		Dynamic _onResume;
		Dynamic _onResumeParams;
		Dynamic _onPause;
		Dynamic _onPauseParams;
		bool _reflect;
		int _repeat;
		bool _reverse;
		bool _smartRotation;
		...
		virtual ::motion::actuators::IGenericActuator onPause( Dynamic handler,Dynamic parameters);
		Dynamic onPause_dyn();

		virtual ::motion::actuators::IGenericActuator onResume( Dynamic handler,Dynamic parameters);
