...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(24)
	this->scaleMode = ::openfl::_v2::display::LineScaleMode_obj::NORMAL;
	HX_STACK_LINE(25)
	this->capsStyle = ::openfl::_v2::display::CapsStyle_obj::ROUND;
	HX_STACK_LINE(26)
	this->jointStyle = ::openfl::_v2::display::JointStyle_obj::ROUND;
	HX_STACK_LINE(27)
	this->miterLimit = 3.0;
}
;
...
Dynamic LineStyle_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"scaleMode") ) { scaleMode=inValue.Cast< ::openfl::_v2::display::LineScaleMode >(); return inValue; }
		if (HX_FIELD_EQ(inName,"capsStyle") ) { capsStyle=inValue.Cast< ::openfl::_v2::display::CapsStyle >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"jointStyle") ) { jointStyle=inValue.Cast< ::openfl::_v2::display::JointStyle >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::display::LineScaleMode*/ ,(int)offsetof(LineStyle_obj,scaleMode),HX_CSTRING("scaleMode")},
	{hx::fsObject /*::openfl::_v2::display::CapsStyle*/ ,(int)offsetof(LineStyle_obj,capsStyle),HX_CSTRING("capsStyle")},
	{hx::fsObject /*::openfl::_v2::display::JointStyle*/ ,(int)offsetof(LineStyle_obj,jointStyle),HX_CSTRING("jointStyle")},
