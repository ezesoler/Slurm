...
Void GfxBytes_obj::__construct(::openfl::_v2::utils::ByteArray inBuffer,hx::Null< int >  __o_inFlags)
{
...
int inFlags = __o_inFlags.Default(0);
{
	...
	if (((inBuffer == null()))){
		HX_STACK_LINE(47)
		_g = ::openfl::_v2::utils::ByteArray_obj::__new(null());
	}
	else{
		HX_STACK_LINE(47)
		_g = inBuffer;
...
hx::ObjectPtr< GfxBytes_obj > GfxBytes_obj::__new(::openfl::_v2::utils::ByteArray inBuffer,hx::Null< int >  __o_inFlags)
...
::String GfxBytes_obj::toString( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(59)
	::openfl::_v2::utils::ByteArray buf = ::openfl::_v2::utils::ByteArray_obj::__new(this->buffer->length);		HX_STACK_VAR(buf,"buf");
	HX_STACK_LINE(61)
...
Void GfxBytes_obj::eof( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(91)
		::openfl::_v2::utils::ByteArray _this = this->buffer;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(91)
		...
		while((true)){
			...
			switch( (int)(_g)){
				...
				case (int)11: {
					...
					HX_STACK_LINE(135)
					::openfl::_v2::display::SpreadMethod _g13 = ::format::gfx::GfxBytes_obj::spreadMethods->__get(_g12).StaticCast< ::openfl::_v2::display::SpreadMethod >();		HX_STACK_VAR(_g13,"_g13");
					HX_STACK_LINE(135)
					grad->spread = _g13;
					HX_STACK_LINE(136)
				...
				case (int)20: {
					...
					HX_STACK_LINE(149)
					::openfl::_v2::display::LineScaleMode _g23 = ::format::gfx::GfxBytes_obj::scaleModes->__get(_g22).StaticCast< ::openfl::_v2::display::LineScaleMode >();		HX_STACK_VAR(_g23,"_g23");
					HX_STACK_LINE(149)
					...
					HX_STACK_LINE(150)
					::openfl::_v2::display::CapsStyle _g25 = ::format::gfx::GfxBytes_obj::capsStyles->__get(_g24).StaticCast< ::openfl::_v2::display::CapsStyle >();		HX_STACK_VAR(_g25,"_g25");
					HX_STACK_LINE(150)
					...
					HX_STACK_LINE(151)
					::openfl::_v2::display::JointStyle _g27 = ::format::gfx::GfxBytes_obj::jointStyles->__get(_g26).StaticCast< ::openfl::_v2::display::JointStyle >();		HX_STACK_VAR(_g27,"_g27");
					HX_STACK_LINE(151)
...
::format::gfx::GfxBytes GfxBytes_obj::fromString( ::String inString){
	...
	HX_STACK_LINE(83)
	::openfl::_v2::utils::ByteArray bytes = ::openfl::_v2::utils::ByteArray_obj::fromBytes(_g3);		HX_STACK_VAR(bytes,"bytes");
	HX_STACK_LINE(86)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::utils::ByteArray*/ ,(int)offsetof(GfxBytes_obj,buffer),HX_CSTRING("buffer")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void GfxBytes_obj::__boot()
{
	...
	scaleModes= Array_obj< ::Dynamic >::__new().Add(::openfl::_v2::display::LineScaleMode_obj::NORMAL).Add(::openfl::_v2::display::LineScaleMode_obj::NONE).Add(::openfl::_v2::display::LineScaleMode_obj::VERTICAL).Add(::openfl::_v2::display::LineScaleMode_obj::HORIZONTAL);
	capsStyles= Array_obj< ::Dynamic >::__new().Add(::openfl::_v2::display::CapsStyle_obj::ROUND).Add(::openfl::_v2::display::CapsStyle_obj::NONE).Add(::openfl::_v2::display::CapsStyle_obj::SQUARE);
	jointStyles= Array_obj< ::Dynamic >::__new().Add(::openfl::_v2::display::JointStyle_obj::ROUND).Add(::openfl::_v2::display::JointStyle_obj::MITER).Add(::openfl::_v2::display::JointStyle_obj::BEVEL);
	spreadMethods= Array_obj< ::Dynamic >::__new().Add(::openfl::_v2::display::SpreadMethod_obj::PAD).Add(::openfl::_v2::display::SpreadMethod_obj::REPEAT).Add(::openfl::_v2::display::SpreadMethod_obj::REFLECT);
