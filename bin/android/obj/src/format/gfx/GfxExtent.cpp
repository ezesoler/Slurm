...
Void GfxExtent_obj::addExtent( Float inX,Float inY){
{
		...
		if (((this->extent == null()))){
			HX_STACK_LINE(20)
			::openfl::_v2::geom::Rectangle _g = ::openfl::_v2::geom::Rectangle_obj::__new(inX,inY,(int)0,(int)0);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(20)
			this->extent = _g;
			HX_STACK_LINE(21)
			return null();
...
Dynamic GfxExtent_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"extent") ) { extent=inValue.Cast< ::openfl::_v2::geom::Rectangle >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::geom::Rectangle*/ ,(int)offsetof(GfxExtent_obj,extent),HX_CSTRING("extent")},
	{ hx::fsUnknown, 0, null()}
};
#endif
