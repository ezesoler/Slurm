...
Void GfxGraphics_obj::__construct(::openfl::_v2::display::Graphics inGraphics)
{
...
hx::ObjectPtr< GfxGraphics_obj > GfxGraphics_obj::__new(::openfl::_v2::display::Graphics inGraphics)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::display::Graphics*/ ,(int)offsetof(GfxGraphics_obj,graphics),HX_CSTRING("graphics")},
	{ hx::fsUnknown, 0, null()}
};
#endif
