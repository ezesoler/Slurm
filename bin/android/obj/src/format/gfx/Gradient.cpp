...
HX_STACK_THIS(this)
{
	...
	this->matrix = _g;
	HX_STACK_LINE(20)
	this->spread = ::openfl::_v2::display::SpreadMethod_obj::PAD;
	HX_STACK_LINE(21)
...
Dynamic Gradient_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"spread") ) { spread=inValue.Cast< ::openfl::_v2::display::SpreadMethod >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::geom::Matrix*/ ,(int)offsetof(Gradient_obj,matrix),HX_CSTRING("matrix")},
	{hx::fsObject /*::openfl::_v2::display::SpreadMethod*/ ,(int)offsetof(Gradient_obj,spread),HX_CSTRING("spread")},
