...
Void RenderContext_obj::__construct(::openfl::_v2::geom::Matrix inMatrix,::openfl::_v2::geom::Rectangle inRect,Dynamic inW,Dynamic inH)
{
...
hx::ObjectPtr< RenderContext_obj > RenderContext_obj::__new(::openfl::_v2::geom::Matrix inMatrix,::openfl::_v2::geom::Rectangle inRect,Dynamic inW,Dynamic inH)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::geom::Matrix*/ ,(int)offsetof(RenderContext_obj,matrix),HX_CSTRING("matrix")},
	{hx::fsObject /*::openfl::_v2::geom::Rectangle*/ ,(int)offsetof(RenderContext_obj,rect),HX_CSTRING("rect")},
