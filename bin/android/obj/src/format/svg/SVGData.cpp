...
bool inConvertCubics = __o_inConvertCubics.Default(false);
{
	...
	HX_STACK_LINE(71)
	::openfl::_v2::geom::Matrix _g9 = ::openfl::_v2::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g9,"_g9");
	HX_STACK_LINE(71)
...
Float SVGData_obj::applyTransform( ::openfl::_v2::geom::Matrix ioMatrix,::String inTrans){
	...
	if ((::format::svg::SVGData_obj::mTranslateMatch->match(inTrans))){
		...
		if ((::format::svg::SVGData_obj::mScaleMatch->match(inTrans))){
			...
			if ((::format::svg::SVGData_obj::mMatrixMatch->match(inTrans))){
				...
				HX_STACK_LINE(95)
				::openfl::_v2::geom::Matrix m = ::openfl::_v2::geom::Matrix_obj::__new(_g6,_g8,_g10,_g12,_g14,_g16);		HX_STACK_VAR(m,"m");
				HX_STACK_LINE(104)
				m->concat(ioMatrix);
				HX_STACK_LINE(106)
				ioMatrix->a = m->a;
...
Void SVGData_obj::loadGradient( ::Xml inGrad,::openfl::display::GradientType inType,bool inCrossLink){
{
		...
		if (((  ((inCrossLink)) ? bool(inGrad->exists(HX_CSTRING("xlink:href"))) : bool(false) ))){
			...
			if (((base != null()))){
				...
				HX_STACK_LINE(368)
				::openfl::_v2::geom::Matrix _g2 = base->gradMatrix->clone();		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(368)
				grad->gradMatrix = _g2;
				HX_STACK_LINE(369)
...
::format::svg::Group SVGData_obj::loadGroup( ::format::svg::Group g,::Xml inG,::openfl::_v2::geom::Matrix matrix,::haxe::ds::StringMap inStyles){
	...
	if ((inG->exists(HX_CSTRING("transform")))){
		HX_STACK_LINE(426)
		::openfl::_v2::geom::Matrix _g = matrix->clone();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(426)
		matrix = _g;
		HX_STACK_LINE(427)
...
::format::svg::Path SVGData_obj::loadPath( ::Xml inPath,::openfl::_v2::geom::Matrix matrix,::haxe::ds::StringMap inStyles,bool inIsRect,bool inIsEllipse,hx::Null< bool >  __o_inIsCircle){
	...
	HX_STACK_ARG(inIsCircle,"inIsCircle")
{
		...
		HX_STACK_LINE(529)
		path->stroke_caps = ::openfl::_v2::display::CapsStyle_obj::ROUND;
		HX_STACK_LINE(530)
		path->joint_style = ::openfl::_v2::display::JointStyle_obj::ROUND;
		HX_STACK_LINE(531)
...
::format::svg::Text SVGData_obj::loadText( ::Xml inText,::openfl::_v2::geom::Matrix matrix,::haxe::ds::StringMap inStyles){
