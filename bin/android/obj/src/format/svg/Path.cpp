...
Dynamic Path_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"stroke_caps") ) { stroke_caps=inValue.Cast< ::openfl::_v2::display::CapsStyle >(); return inValue; }
		if (HX_FIELD_EQ(inName,"joint_style") ) { joint_style=inValue.Cast< ::openfl::_v2::display::JointStyle >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::geom::Matrix*/ ,(int)offsetof(Path_obj,matrix),HX_CSTRING("matrix")},
	...
	{hx::fsObject /*::openfl::_v2::display::CapsStyle*/ ,(int)offsetof(Path_obj,stroke_caps),HX_CSTRING("stroke_caps")},
	{hx::fsObject /*::openfl::_v2::display::JointStyle*/ ,(int)offsetof(Path_obj,joint_style),HX_CSTRING("joint_style")},
