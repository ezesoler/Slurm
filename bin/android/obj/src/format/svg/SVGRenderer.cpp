...
Void SVGRenderer_obj::iteratePath( ::format::svg::Path inPath){
{
		...
		HX_STACK_LINE(104)
		::openfl::_v2::geom::Matrix m = inPath->matrix->clone();		HX_STACK_VAR(m,"m");
		HX_STACK_LINE(105)
...
Void SVGRenderer_obj::render( ::openfl::_v2::display::Graphics inGfx,::openfl::_v2::geom::Matrix inMatrix,Dynamic inFilter,::openfl::_v2::geom::Rectangle inScaleRect,Dynamic inScaleW,Dynamic inScaleH){
{
		...
		if (((inMatrix == null()))){
			...
			HX_STACK_LINE(195)
			::openfl::_v2::geom::Matrix _g2 = inMatrix->clone();		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(195)
			this->mMatrix = _g2;
		}
		HX_STACK_LINE(197)
...
Void SVGRenderer_obj::renderRect( ::openfl::_v2::display::Graphics inGfx,Dynamic inFilter,::openfl::_v2::geom::Rectangle scaleRect,::openfl::_v2::geom::Rectangle inBounds,::openfl::_v2::geom::Rectangle inRect){
{
...
Void SVGRenderer_obj::renderRect0( ::openfl::_v2::display::Graphics inGfx,Dynamic inFilter,::openfl::_v2::geom::Rectangle scaleRect,::openfl::_v2::geom::Rectangle inBounds,::openfl::_v2::geom::Rectangle inRect){
{
...
::openfl::_v2::geom::Rectangle SVGRenderer_obj::getExtent( ::openfl::_v2::geom::Matrix inMatrix,Dynamic inFilter,Dynamic inIgnoreDot){
	...
	if (((inMatrix == null()))){
		...
		HX_STACK_LINE(248)
		::openfl::_v2::geom::Matrix _g1 = inMatrix->clone();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(248)
		this->mMatrix = _g1;
	}
	HX_STACK_LINE(250)
...
::openfl::_v2::geom::Rectangle SVGRenderer_obj::getMatchingRect( ::EReg inMatch){
...
Void SVGRenderer_obj::renderObject( ::openfl::_v2::display::DisplayObject inObj,::openfl::_v2::display::Graphics inGfx,::openfl::_v2::geom::Matrix inMatrix,Dynamic inFilter,::openfl::_v2::geom::Rectangle inScale9){
{
		...
		HX_STACK_LINE(279)
		::openfl::_v2::geom::Rectangle rect = this->getExtent(inMatrix, Dynamic(new _Function_1_1()),null());		HX_STACK_VAR(rect,"rect");
	}
return null();
}
...
Void SVGRenderer_obj::renderSprite( ::openfl::_v2::display::Sprite inObj,::openfl::_v2::geom::Matrix inMatrix,Dynamic inFilter,::openfl::_v2::geom::Rectangle inScale9){
{
		...
		HX_STACK_ARG(inScale9,"inScale9")
		HX_STACK_LINE(292)
		::openfl::_v2::display::Graphics _g = inObj->get_graphics();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(292)
...
::openfl::_v2::display::Shape SVGRenderer_obj::createShape( ::openfl::_v2::geom::Matrix inMatrix,Dynamic inFilter,::openfl::_v2::geom::Rectangle inScale9){
	...
	HX_STACK_LINE(298)
	::openfl::_v2::display::Graphics _g = shape->get_graphics();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(298)
...
::openfl::_v2::display::Shape SVGRenderer_obj::namedShape( ::String inName){
...
::openfl::_v2::display::BitmapData SVGRenderer_obj::renderBitmap( ::openfl::_v2::geom::Rectangle inRect,hx::Null< Float >  __o_inScale){
...
{
		HX_STACK_LINE(310)
		::openfl::_v2::geom::Matrix _g = ::openfl::_v2::geom::Matrix_obj::__new(inScale,(int)0,(int)0,inScale,(-(inRect->x) * inScale),(-(inRect->y) * inScale));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(310)
		this->mMatrix = _g;
		HX_STACK_LINE(312)
		...
		HX_STACK_LINE(315)
		::openfl::_v2::display::BitmapData bmp = ::openfl::_v2::display::BitmapData_obj::__new(w,h,true,(int)0,null());		HX_STACK_VAR(bmp,"bmp");
		HX_STACK_LINE(317)
		::openfl::_v2::display::Shape shape = ::openfl::_v2::display::Shape_obj::__new();		HX_STACK_VAR(shape,"shape");
		HX_STACK_LINE(318)
		::openfl::_v2::display::Graphics _g3 = shape->get_graphics();		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(318)
...
Dynamic SVGRenderer_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"mMatrix") ) { mMatrix=inValue.Cast< ::openfl::_v2::geom::Matrix >(); return inValue; }
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"mScaleRect") ) { mScaleRect=inValue.Cast< ::openfl::_v2::geom::Rectangle >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::geom::Matrix*/ ,(int)offsetof(SVGRenderer_obj,mMatrix),HX_CSTRING("mMatrix")},
	{hx::fsObject /*::openfl::_v2::geom::Rectangle*/ ,(int)offsetof(SVGRenderer_obj,mScaleRect),HX_CSTRING("mScaleRect")},
