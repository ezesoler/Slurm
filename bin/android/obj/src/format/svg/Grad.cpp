...
Void Grad_obj::updateMatrix( ::openfl::_v2::geom::Matrix inMatrix){
{
...
Dynamic Grad_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 6:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"gradMatrix") ) { gradMatrix=inValue.Cast< ::openfl::_v2::geom::Matrix >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::geom::Matrix*/ ,(int)offsetof(Grad_obj,gradMatrix),HX_CSTRING("gradMatrix")},
