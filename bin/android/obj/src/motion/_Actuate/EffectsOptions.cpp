...
{
HX_STACK_FRAME("motion._Actuate.EffectsOptions","new",0xd8cd76d4,"motion._Actuate.EffectsOptions.new","motion/Actuate.hx",427,0xcac92ba8)
HX_STACK_THIS(this)
...
::motion::actuators::IGenericActuator EffectsOptions_obj::filter( Dynamic reference,Dynamic properties){
	HX_STACK_FRAME("motion._Actuate.EffectsOptions","filter",0x8473f9c4,"motion._Actuate.EffectsOptions.filter","motion/Actuate.hx",442,0xcac92ba8)
	HX_STACK_THIS(this)
