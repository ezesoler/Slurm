...
Void FilterActuator_obj::__construct(::openfl::_v2::display::DisplayObject target,Float duration,Dynamic properties)
{
...
HX_STACK_ARG(properties,"properties")
{
	...
	if ((::Std_obj::is(properties->__Field(HX_CSTRING("filter"),true),hx::ClassOf< ::Class >()))){
		...
		HX_STACK_LINE(27)
		if (((target->get_filters()->__Field(HX_CSTRING("length"),true) == (int)0))){
			HX_STACK_LINE(28)
			::openfl::_v2::filters::BitmapFilter _g = ::Type_obj::createInstance(this->filterClass,Dynamic( Array_obj<Dynamic>::__new()));		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(28)
			Dynamic _g1 = Dynamic( Array_obj<Dynamic>::__new().Add(_g));		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(28)
		...
		HX_STACK_LINE(31)
		{
			...
			HX_STACK_LINE(31)
			Dynamic _g1 = target->get_filters();		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(31)
			while((true)){
				HX_STACK_LINE(31)
		...
		HX_STACK_LINE(44)
		Dynamic _g2 = target->get_filters();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(44)
		::openfl::_v2::filters::BitmapFilter _g3 = _g2->__GetItem(this->filterIndex);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(44)
		this->filter = _g3;
	}
}
...
hx::ObjectPtr< FilterActuator_obj > FilterActuator_obj::__new(::openfl::_v2::display::DisplayObject target,Float duration,Dynamic properties)
...
Void FilterActuator_obj::setField_openfl__v2_display_DisplayObject( ::openfl::_v2::display::DisplayObject target,::String propertyName,Dynamic value){
{
		HX_STACK_FRAME("motion.actuators.FilterActuator","setField_openfl__v2_display_DisplayObject",0x9f27d3a7,"motion.actuators.FilterActuator.setField_openfl__v2_display_DisplayObject","motion/actuators/SimpleActuator.hx",302,0x731927e5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(target,"target")
...
HX_DEFINE_DYNAMIC_FUNC3(FilterActuator_obj,setField_openfl__v2_display_DisplayObject,(void))
...
Void FilterActuator_obj::apply( ){
{
		...
		{
			HX_STACK_LINE(63)
			::openfl::_v2::display::DisplayObject target = this->target;		HX_STACK_VAR(target,"target");
			HX_STACK_LINE(63)
		...
		HX_STACK_LINE(75)
		{
			...
			while((true)){
				...
				if (((propertyName != HX_CSTRING("filter")))){
					...
					{
						HX_STACK_LINE(79)
						::openfl::_v2::filters::BitmapFilter target = this->filter;		HX_STACK_VAR(target,"target");
						HX_STACK_LINE(79)
						Dynamic value = null();		HX_STACK_VAR(value,"value");
						HX_STACK_LINE(79)
						if ((::Reflect_obj::hasField(target,propertyName))){
...
Void FilterActuator_obj::update( Float currentTime){
{
		...
		HX_STACK_LINE(97)
		Dynamic filters = this->target->__Field(HX_CSTRING("get_filters"),true)();		HX_STACK_VAR(filters,"filters");
		HX_STACK_LINE(99)
...
Dynamic FilterActuator_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 11:
		...
		break;
	case 41:
		if (HX_FIELD_EQ(inName,"setField_openfl__v2_display_DisplayObject") ) { return setField_openfl__v2_display_DisplayObject_dyn(); }
	}
...
static ::String sMemberFields[] = {
	HX_CSTRING("setField_openfl__v2_display_DisplayObject"),
	HX_CSTRING("filter"),
