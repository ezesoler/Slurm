...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__fonts_opensans_regular_ttf);
...
@:keep #if display private #end class __ASSET__fonts_opensans_regular_ttf extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "Open Sans"; } #end }
