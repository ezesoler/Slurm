...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Ezequiel Soler", "Slurm", "com.Slurm", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Slurm", null, { width: 480, height: 800 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 480, height: 800 });
			#end
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.Main, []);
			}
